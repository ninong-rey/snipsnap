...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.twilio.sid' => 'string',
            'services.twilio.token' => 'string',
            'services.twilio.from' => 'string',
...
'filesystems.links./Users/johnreycasilagan/Documents/demo-app/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.twilio.sid','services.twilio.token','services.twilio.from','session.driver','session.lifetime',
...
'sanctum.csrf-cookie','home','login','login.perform',
'signup.view','signup.perform','password.request','otp.request','password.reset',
'otp.verify','logout.perform','my-web','upload','upload.store',
'following.videos','profile.show','profile.update','user.profile','users.profile',
'users.followers','users.following','users.videos','users.liked-videos','video.show',
'video.like','video.unlike','video.share','comment.store','explore.users',
'follow.toggle','follow.status','users.suggestions','users.search','friends',
'notifications','notifications.read','notifications.read-all','notifications.unread-count','messages.index',
'messages.show','messages.send','messages.fetchNew','storage.local',);
        registerArgumentsSet('views', 
'Messages','Upload','auth.verify-otp','components.reset-form','demo',
'emails.otp','explore-user','following','friends','layouts.app',
'login','messages.index','notifications','otp','profile',
'reset','reset-password','signup','video','web',
...
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','TWILIO_SID','TWILIO_AUTH_TOKEN',
'TWILIO_PHONE','TWILIO_VERIFY_SID','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
