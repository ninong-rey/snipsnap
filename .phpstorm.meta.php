...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.cloudinary.cloud' => 'string',
            'filesystems.disks.cloudinary.key' => 'string',
            'filesystems.disks.cloudinary.secret' => 'string',
            'filesystems.links./Users/johnreycasilagan/Documents/demo-app/public/storage' => 'string',
...
'cache.stores.dynamodb.table','cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','cloudinary.notification_url',
'cloudinary.cloud_url','cloudinary.upload_preset','cloudinary.upload_route','cloudinary.upload_action','database.default',
...
'filesystems.disks.cloudinary.driver','filesystems.disks.cloudinary.cloud','filesystems.disks.cloudinary.key','filesystems.disks.cloudinary.secret','filesystems.links./Users/johnreycasilagan/Documents/demo-app/public/storage',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.twilio.sid',
'services.twilio.token','services.twilio.from','session.driver','session.lifetime','session.expire_on_close',
...
'web','api','auth','guest','throttle',
'verified',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','storage.local',);
        registerArgumentsSet('views', 
'auth.verify-otp','call-join','components.reset-form','demo','emails.otp',
'explore-user','fake-notification','following','friends','layouts.app',
'login','messages.index','notifications','otp','profile',
'reset','reset-password','signup','test-upload','upload',
'video','video-debug','web','welcome','cloudinary::components.image',
'cloudinary::components.video','cloudinary::components.widget','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403',
...
'FILESYSTEM_DISK','CLOUDINARY_CLOUD_NAME','CLOUDINARY_API_KEY','CLOUDINARY_API_SECRET','CLOUDINARY_CLOUD',
'CLOUDINARY_KEY','CLOUDINARY_SECRET','DB_CONNECTION','DB_HOST','DB_PORT',
'DB_USERNAME','DB_PASSWORD','FILESYSTEM_DISK','SESSION_DRIVER','QUEUE_CONNECTION',
'CACHE_STORE','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','VITE_APP_NAME',
'DB_CONNECTION','FRONTEND_URL','BACKEND_URL','SESSION_DOMAIN','FRONTEND_URL',
'BACKEND_URL','SESSION_DOMAIN','DB_DATABASE',);
